...
// ONLY replace the definition of the method exactly once
$content = preg_replace('/public function createBooking\(/', $cartMethod . "\n\n    public function createBooking(", $content, 1);

file_put_contents($file, $content);
echo "Patched BookingService.php with createCartBookings (fixed)\n";
?>
