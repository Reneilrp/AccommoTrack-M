...
export default function PricingHelp({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true">
      ...
      <div className="relative max-w-2xl w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 z-10 max-h-[80vh] overflow-hidden">
        <div className="flex items-start justify-between">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Pricing formula help</h3>
        ...
        <div className="mt-4 text-sm text-gray-700 dark:text-gray-300 space-y-3 overflow-y-auto pr-2" style={{ maxHeight: '60vh' }}>
          ...
          <div>
            <strong className="text-gray-900 dark:text-white">monthly_rate</strong>: fixed price for a full month (e.g. ₱5,000 / month).
          </div>
        ...
        <div className="mt-6 text-right">
          <button onClick={onClose} className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors">Got it</button>
        </div>
      </div>
    </div>
  );
