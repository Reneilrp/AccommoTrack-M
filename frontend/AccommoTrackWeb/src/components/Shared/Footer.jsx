  ...
  return (
    <footer className="w-full bg-white dark:bg-gray-800/50 backdrop-blur-md border-t border-gray-200 dark:border-gray-700 py-12 md:py-16 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        {/* Center: Links */}
        <div className="flex flex-wrap justify-center gap-2 text-sm font-bold text-gray-600 dark:text-gray-300 order-1 md:order-2">
          ...
          <div><Link to="/help" className="hover:text-green-600 dark:hover:text-green-500 transition-all hover:scale-105 active:scale-95">
            Help Center
          </Link></div>
        </div>
