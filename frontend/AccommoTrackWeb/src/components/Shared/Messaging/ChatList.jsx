  ...
  return (
    <div className="w-full h-full bg-white dark:bg-gray-800 border-r border-gray-300 dark:border-gray-700 flex flex-col overflow-hidden">
      <div className="p-4 border-b border-gray-300 dark:border-gray-700">
        ...
        {/* Filter Panel */}
        {showFilters && (
          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-300 dark:border-gray-600 space-y-4">
            ...
            <div>
              <label className="block text-xs text-gray-500 dark:text-gray-400 mb-2">Property</label>
        ...
        {caretakerMessagingRestricted && (
          <div className="mt-4 p-4 bg-amber-50 border border-gray-300 rounded-lg flex gap-2 text-amber-800 text-sm">
            ...
            >
              ...
              <div className="flex-1 text-left min-w-0">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-[10px] text-gray-500 dark:text-gray-500 whitespace-nowrap ml-2">
