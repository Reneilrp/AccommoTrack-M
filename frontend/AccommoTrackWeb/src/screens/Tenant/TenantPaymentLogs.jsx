      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-2 sticky top-14 md:top-18 z-20">
        <div className="max-w-7xl mx-auto">
          <div className="flex bg-gray-100 dark:bg-gray-900/50 p-1 rounded-xl relative">
            ...
            <div
              className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-white dark:bg-gray-700 rounded-lg shadow-sm transition-all duration-300 ease-in-out ${activeTab === 'archive' ? 'translate-x-full' : 'translate-x-0'
                }`}
            />

            <button
              onClick={() => setActiveTab('logs')}
              className={`relative z-10 flex-1 py-2 text-sm font-bold transition-colors ${activeTab === 'logs' ? 'text-green-600 dark:text-green-400' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                }`}
            >
              Full Payment Log
            </button>
            <button
              ...
              className={`relative z-10 flex-1 py-2 text-sm font-bold transition-colors ${activeTab === 'archive' ? 'text-green-600 dark:text-green-400' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                }`}
            >
              Payment Archive
            </button>
