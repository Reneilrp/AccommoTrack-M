      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex items-center gap-6">
          <div className="relative">
            <div className="w-24 h-24 rounded-full overflow-hidden bg-gray-100 border-2 border-white shadow-sm">
               {imagePreview ? (
            ...
            <label className={`absolute bottom-0 right-0 bg-white rounded-full p-2 shadow-md hover:bg-gray-50 border border-gray-200 ${!isEditing ? 'hidden' : 'cursor-pointer'}`}>
             ...
             <div className="flex flex-col gap-2">
                ...
                {genderMode === 'Others' && (
                    <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent animate-fadeIn disabled:bg-gray-50 disabled:text-gray-500"
                    />
                )}
            </div>
          </div>
