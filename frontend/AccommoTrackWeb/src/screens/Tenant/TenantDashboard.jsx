    ...
    <div className="space-y-6">
      ...
      {stayData?.hasActiveStay ? (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="bg-brand-50 dark:bg-brand-900/30 p-4 rounded-lg border border-brand-100 dark:border-brand-800">
                  <p className="text-sm text-brand-600 dark:text-brand-400 font-medium uppercase tracking-wider">Current Room</p>
                  <p className="text-2xl font-bold text-brand-900 dark:text-brand-100 mt-1">
                    {stayData.room?.room_number}
                  </p>
                  <p className="text-xs text-brand-700 dark:text-brand-300 mt-1 capitalize">{stayData.room?.type}</p>
                </div>

                <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                  <p className="text-sm text-blue-600 dark:text-blue-400 font-medium uppercase tracking-wider">Days Stayed</p>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/30 p-4 rounded-lg border border-purple-100 dark:border-purple-800">
                  <p className="text-sm text-purple-600 dark:text-purple-400 font-medium uppercase tracking-wider">Monthly Rent</p>
                  <p className="text-2xl font-bold text-purple-900 dark:text-purple-100 mt-1">
                    {formatCurrency(stayData.booking?.monthly_rent)}
                  </p>
                  <p className="text-xs text-purple-700 dark:text-purple-300 mt-1">Due on {stayData.booking?.due_day}th of month</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 -mx-6 -mb-6 p-6">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Property Manager</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              <h3 className="font-bold text-gray-900 dark:text-white mb-4">Payment Overview</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-4 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-gray-600 dark:text-gray-300">Pending Due</span>
                  <span className="font-bold text-red-600 dark:text-red-400">{formatCurrency(stats?.payments?.monthlyDue || 0)}</span>
                </div>
                <div className="flex justify-between items-center pb-4 border-b border-gray-100 dark:border-gray-700">
                  <span className="text-gray-600 dark:text-gray-300">Total Paid</span>
                  <span className="font-bold text-green-600 dark:text-green-400">{formatCurrency(stats?.payments?.totalPaid || 0)}</span>
                </div>
                <button 
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-2">
                ...
                >
                  <span className="text-gray-700 dark:text-gray-200">View Property Details</span>
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left"
                >
                  <span className="text-gray-700 dark:text-gray-200">Booking History</span>
                  <svg className="w-5 h-5 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">No Active Stay</h2>
          ...
          {stayData?.upcomingBooking && (
            <div className="mt-8 bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 rounded-lg p-4 max-w-lg mx-auto text-left flex items-start gap-4">
              ...
              <div>
                <p className="font-bold text-blue-900 dark:text-blue-100">Upcoming Stay Available</p>
                ...
                <button 
                  onClick={() => navigate('/bookings')}
                  className="text-sm text-blue-800 dark:text-blue-200 font-semibold mt-2 hover:underline"
                >
                  View Details &rarr;
                </button>
              </div>
