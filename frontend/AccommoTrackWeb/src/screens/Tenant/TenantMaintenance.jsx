          ...
          {requests.length === 0 ? (
            ...
            requests.map((req) => (
              <div
                ...
                className={`group cursor-pointer bg-white dark:bg-gray-800 rounded-2xl border transition-all ${selectedRequest?.id === req.id
              ...
              >
                <div className="p-5 flex items-start gap-4">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors ${selectedRequest?.id === req.id
                      ...
                      {requestHistory.length === 0 ? (
                        ...
                        requestHistory.map((item, idx) => (
                          <div key={item.id} className="relative pl-10">
                            {/* Dot */}
                            <div className={`absolute left-[7px] top-1.5 w-[10px] h-[10px] rounded-full border-2 border-white dark:border-gray-800 z-10 ${idx === 0 ? 'bg-green-500 ring-4 ring-green-100 dark:ring-green-900/40' : 'bg-gray-300 dark:bg-gray-600'
                              }`} />
