  ...
  <section id="about" className="py-24 px-6 max-w-7xl mx-auto">
    <div className="bg-white dark:bg-gray-800 rounded-[40px] p-8 md:p-16 text-center border border-gray-100 dark:border-gray-700 shadow-md">
      ...
      <div className="flex flex-col md:grid md:grid-cols-3 gap-6 md:gap-10 max-h-[400px] md:max-h-none overflow-y-auto md:overflow-y-visible snap-y snap-mandatory no-scrollbar p-1">
        <div className="flex-none w-full md:w-auto snap-start text-center p-8 rounded-[32px] border border-gray-100 dark:border-gray-700 shadow-sm bg-gray-50/30 dark:bg-gray-900/20 hover:bg-white dark:hover:bg-gray-700 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
