...
const About = () => (
  <section className="min-h-[calc(100vh-56px)] md:min-h-[calc(100vh-72px)] flex flex-col justify-center py-12 px-6 bg-gray-50 dark:bg-gray-900">
    <div className="max-w-7xl mx-auto w-full">
      <div className="bg-white dark:bg-gray-800 rounded-[40px] p-8 md:p-16 text-center border border-gray-100 dark:border-gray-700 shadow-md">
        ...
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-[800px] mx-auto mb-12 leading-relaxed">
        ...
        <div className="flex flex-row md:grid md:grid-cols-3 gap-6 md:gap-10 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory no-scrollbar p-2">
          <div className="flex-none w-[85%] sm:w-[60%] md:w-auto snap-center md:snap-start text-center p-8 rounded-[32px] border border-gray-100 dark:border-gray-700 shadow-sm bg-gray-50/30 dark:bg-gray-900/20 hover:bg-white dark:hover:bg-gray-700 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
