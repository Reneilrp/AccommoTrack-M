...
const Service = ({ onGetStarted }) => (
  ...
  >
    <div className="max-w-7xl mx-auto">
      ...
      <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-[700px] mx-auto mb-16 leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        {/* Service Card 1 */}
        <div className="bg-white dark:bg-gray-800 rounded-[32px] p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.05)] hover:-translate-y-2 transition-transform duration-300">
