  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Manage pending landlord verifications and property listings.</p>
      </div>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 mb-6">
        <nav className="-mb-px flex space-x-8" aria-label="Tabs">
          <button
            ...
            className={`
              whitespace-nowrap py-4 px-2 border-b-2 font-bold text-sm transition-colors
              ${activeTab === 'landlords'
