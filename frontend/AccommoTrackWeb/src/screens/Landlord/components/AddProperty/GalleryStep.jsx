...
import { Camera, Upload, X, Star, Video, Play, Trash } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
      <div>
        ...
        <p className="text-sm text-gray-500">Add photos and a virtual tour to showcase your property.</p>
      </div>

      <div className="space-y-4">
        <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest">Photos (Max 8)</label>
        ...
        {videoPreview ? (
          ...
          <label className="max-w-md aspect-video rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 flex flex-col items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all cursor-pointer group">
            ...
            <div className="text-center">
              <span className="block text-xs font-bold text-gray-500">Upload Video Tour</span>
