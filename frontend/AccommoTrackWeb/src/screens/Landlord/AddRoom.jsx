      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-center relative">
            ...
            <button
              onClick={onClose}
              className="text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors absolute right-0"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div>
                ...
                />
                {fieldErrors.roomNumber && <p className="text-red-500 text-xs mt-2">{fieldErrors.roomNumber}</p>}
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-2 items-end min-w-0">
              ...
              <div>
                ...
                />
                {fieldErrors.dailyRate && <p className="text-red-500 text-xs mt-2">{fieldErrors.dailyRate}</p>}
              </div>
            </div>
            ...
            {formData.roomType !== "single" && formData.roomType !== "bedSpacer" && (
              <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <div className="space-y-4">
                  <label
                    className={`flex items-center gap-4 p-4 border border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors ${formData.pricingModel === "full_room" ? "bg-blue-100 dark:bg-blue-900/50" : ""}`}
                  >
                    <input
                      type="radio"
                      name="pricingModel"
                  ...
                  <label
                    className={`flex items-center gap-4 p-4 border border-gray-200 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors ${formData.pricingModel === "per_bed" ? "bg-blue-100 dark:bg-blue-900/50" : ""}`}
                  >
                    <input
                      type="radio"
                      name="pricingModel"
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {previewImages.length === 0 ? (
                ...
                >
                  <Upload className="w-10 h-10 text-gray-500 dark:text-gray-500 mx-auto mb-2" />
                  ...
                  <div className="grid grid-cols-5 gap-4">
                    {previewImages.map((img, index) => (
                      ...
                      >
                        ...
                        {index === 0 && (
                          <span className="absolute left-2 top-2 bg-green-600 text-white text-xs px-2 py-2 rounded-full">
                            Cover
                          </span>
                        )}
                        ...
                        <button
                          ...
                          title="Remove image"
                          className="absolute top-2 right-2 p-2 bg-white dark:bg-gray-800 bg-opacity-90 text-gray-700 dark:text-gray-300 rounded-full shadow-sm hover:bg-opacity-100 transition-colors"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </div>
