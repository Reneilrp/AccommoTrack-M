	...
	*/
	listenToAll(e) {
		return this.subscription.bind_global((t, s) => {
			...
			let r = String(this.options.namespace ?? "").replace(/\./g, "\\"), a = t.startsWith(r) ? t.substring(r.length + 1) : "." + t;
			e(a, s);
		}), this;
	}
	/**
...
var E = class {
	...
	*/
	connect() {
		...
		else if (this.options.broadcaster === "socket.io") this.connector = new I(this.options);
		else if (this.options.broadcaster === "null") this.connector = new p(this.options);
		else if (typeof this.options.broadcaster == "function" && w(this.options.broadcaster)) this.connector = new this.options.broadcaster(this.options);
...
//#endregion
export { u as Channel, i as Connector, d as EventFormatter, E as default };
